...
const Navbar = () => {
    ...
    useEffect(() => {
        const myFunction = () => {
            ...
            else if (LP.includes("/sign-up")) {
                setPath("none")
            }
            else if (LP.includes("/examples")) {
                setIsActive(current => !current)
                setIsActive2(false)
                setIsActive3(false)
            }
            else if (LP.includes("/download")) {
            ...
            else if (LP.includes("/") && LP.includes("/how-it-works")) {
                setIsActive2(false)
                setIsActive(false)
                setIsActive3(false)
            }
        ...
        <div className='main' style={{ top: position, display: toPath }}>
            ...
            <div className="bg-pr" style={{ transform: click ? "translateY( 100px)" : "translateY(-40px)" }}>
                <div className="product" onMouseLeave={mouseLeavetoProducts} onMouseEnter={mouseEntertoProducts} style={{ display: click ? "flex" : "none" }}>
                    <div className="container" onMouseLeave={mouseLeavetoProducts} onMouseEnter={mouseEntertoProducts} style={{ display: click ? "grid" : "none" }}>
                        {/* ===========================Overflow started==================================== */}

                        <div className="row" onMouseLeave={mouseLeavetoProducts} onMouseEnter={mouseEntertoProducts} style={{ display: click ? "block" : "none" }}>
                            <h3 className="over" onMouseLeave={mouseLeavetoProducts} onMouseEnter={mouseEntertoProducts} style={{ display: click ? "flex" : "none" }}>
                                OVERFLOW
                            </h3>
                            <Link to={'how-it-works'}>
                                <div className="box over1" onClick={mouseLeavetoProducts}>
                                    <div className="icon" >
                                        <BsSortDown />
                                    </div>
